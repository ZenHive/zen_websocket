# Changelog Archive — 0.1.1 through 0.4.3

Superseded entries, kept verbatim. Current releases are in
[CHANGELOG.md](CHANGELOG.md).

Provenance is uneven across this range: 0.1.5, 0.2.0 and 0.3.1 were published to
Hex but never tagged on GitHub, 0.4.0 was neither tagged nor published, and
0.4.3 carries a git tag but was never published to Hex. Links below point at
whichever artifact actually exists for each version.
...
## 0.4.0 - 2026-04-12 (unreleased — never tagged or published)
...
Published to Hex without a changelog entry; the changes it carried were not
recorded at release time. Compare `v0.1.4...v0.2.0` on GitHub for the range
that spans it.
...
[0.4.1]: https://github.com/ZenHive/zen_websocket/compare/v0.3.0...v0.4.1
[0.3.1]: https://hex.pm/packages/zen_websocket/0.3.1
[0.3.0]: https://github.com/ZenHive/zen_websocket/compare/v0.1.4...v0.3.0
[0.2.0]: https://hex.pm/packages/zen_websocket/0.2.0
[0.1.5]: https://hex.pm/packages/zen_websocket/0.1.5
[0.1.4]: https://github.com/ZenHive/zen_websocket/releases/tag/v0.1.4
[0.1.3]: https://hex.pm/packages/zen_websocket/0.1.3
[0.1.2]: https://hex.pm/packages/zen_websocket/0.1.2
[0.1.1]: https://hex.pm/packages/zen_websocket/0.1.1
