  ...
  def project do
    [
      ...
      docs: [
        ...
        # workflow and unrelated internal project references. It stays in the
        # repo for the cross-family reviewer and is gated by `mix agents.check`,
        # but it is not consumer documentation and must not reach hexdocs.
        extras: [
          "README.md",
          "CHANGELOG.md",
